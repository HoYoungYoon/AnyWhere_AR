...
public class MixContext extends ContextWrapper {
	...
	Context ctx;
	Location lastFix; //근래 마지막 위치값 위치값
	...
	public MixContext(Context appCtx) {
		...
		try {
			...
			if(permissionLocation == PackageManager.PERMISSION_DENIED) {
				ActivityCompat.requestPermissions(mixView, new String[]{Manifest.permission.ACCESS_FINE_LOCATION , Manifest.permission.ACCESS_COARSE_LOCATION}, MixView.REQUEST_LOCATION);
			} else {
	...
	public Location getCurrentGPSInfo() {
		...
		if(permissionLocation == PackageManager.PERMISSION_DENIED) {
			ActivityCompat.requestPermissions(mixView, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, MixView.REQUEST_LOCATION);
			return curLoc;
			} else {
