...
public class NavigationMarker extends Marker {
    ...
    public NavigationMarker(String title, int likeCnt ,double latitude, double longitude,
                            double altitude, String URL) {
        super(title,likeCnt ,latitude, longitude, altitude, URL);
